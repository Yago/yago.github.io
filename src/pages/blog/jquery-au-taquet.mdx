...
export const meta = {
  ...
  date: "2016-04-24T12:56:00.000Z",
  type: "post",
  description: "jQuery fêtera ses 10 ans le 29 août prochain. Malgré sa perte progressive de sex appeal, peu d'autres librairies peuvent se targuer d'une aussi belle longévité.",
  nocover: true
}; // end-meta
