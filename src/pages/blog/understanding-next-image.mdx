...
As we quickly saw earlier, the `size` property is `100vw` by default. If you want a perfect match to your image size, you can use something like [react-cool-dimensions](https://github.com/wellyshen/react-cool-dimensions) and wrap the `<Image />` into a new component.
